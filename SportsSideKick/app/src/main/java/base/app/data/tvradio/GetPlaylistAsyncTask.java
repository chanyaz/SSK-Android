...
public abstract class GetPlaylistAsyncTask extends AsyncTask<String, Void, Pair<String, List<Video>>> {
    ...
    private static final String YOUTUBE_VIDEOS_FIELDS = "items(id,snippet(title,publishedAt,thumbnails/high),contentDetails/duration,statistics)"; // selector specifying which fields to include in a partial response.
