...
public class MainActivityTablet extends BaseActivity implements LoginStateReceiver.LoginListener {
    ...
    private void setupFragments() {
        ...
        bottomRightContainerFragments.add(TvPlaylistsFragment.class);
        bottomRightContainerFragments.add(TvVideosFragment.class);
        bottomRightContainerFragments.add(RadioFragment.class);
        bottomRightContainerFragments.add(TvPlayerFragment.class);
        ...
        radioButtonsFragmentMap.put(R.id.club_tv_radio_button, TvPlaylistsFragment.class);
        ...
        EventBus.getDefault().post(new FragmentEvent(TvPlaylistsFragment.class));
