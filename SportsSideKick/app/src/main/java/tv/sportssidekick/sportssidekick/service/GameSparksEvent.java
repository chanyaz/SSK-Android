...
public class GameSparksEvent extends BusEvent {
    ...
    public enum Type {
            ...
            FRIEND_DOWNLOADED,
            TYPING,
            ACCOUNT_DETAILS_ERROR, REGISTRATION_ERROR, REGISTRATION_SUCCESSFUL, PASSWORD_RECOVERY_ERROR, PASSWORD_RECOVERY_SUCCESSFUL, USER_STATE_UPDATE_ERROR, USER_STATE_UPDATE_SUCCESSFUL,
    }
